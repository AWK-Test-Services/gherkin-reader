...
class ExampleTokenEverywhereTest {
    ...
    void readFile() {
        ...
        try {
            lineReader = getLineReader(DIRECTORY_GOOD + "example_tokens_everywhere.feature");
        } catch (IOException e) {
            e.printStackTrace();
        ...
        assertEquals("Example tokens everywhere", feature.getName());
