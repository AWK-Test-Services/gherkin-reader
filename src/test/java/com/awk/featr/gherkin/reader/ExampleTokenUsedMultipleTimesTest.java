...
class ExampleTokenUsedMultipleTimesTest {
    ...
    void readFile() {
        ...
        try {
            lineReader = getLineReader(DIRECTORY_GOOD + "example_token_multiple.feature");
        } catch (IOException e) {
            e.printStackTrace();
        ...
        assertEquals("Example token used multiple times", feature.getName());
