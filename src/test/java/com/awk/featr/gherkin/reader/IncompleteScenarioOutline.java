...
class IncompleteScenarioOutline {
    private List<Step> steps;

    // TODO combine Incomplete Scenario Outline test with ScenarioOutlineTest

    @BeforeAll
    void readFile() {
        LineReader lineReader = null;
        try {
            lineReader = getLineReader(DIRECTORY_GOOD + "incomplete_scenario_outline.feature");
        } catch (IOException e) {
            e.printStackTrace();
        ...
        assertEquals("Incomplete scenario outlines", feature.getName());
