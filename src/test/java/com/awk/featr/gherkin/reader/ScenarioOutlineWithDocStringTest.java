...
class ScenarioOutlineWithDocStringTest {
    ...
    void readFile() {
        ...
        try {
            lineReader = getLineReader(DIRECTORY_GOOD + "scenario_outline_with_docstring.feature");
        } catch (IOException e) {
            e.printStackTrace();
        ...
        assertEquals("Scenario Outline with a docstring", feature.getName());
