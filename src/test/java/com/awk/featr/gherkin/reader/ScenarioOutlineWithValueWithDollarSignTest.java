...
class ScenarioOutlineWithValueWithDollarSignTest {
    ...
    void readFile() {
        ...
        try {
            lineReader = getLineReader(DIRECTORY_GOOD + "scenario_outline_with_value_with_dollar_sign.feature");
        } catch (IOException e) {
            e.printStackTrace();
        ...
        assertEquals("Scenario Outline with a value with a dollar sign ($)", feature.getName());
