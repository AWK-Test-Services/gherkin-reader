...
class incompleteBackgroundTest2 {
    ...
    void readFile() {
        ...
        try {
            lineReader = getLineReader(DIRECTORY_GOOD + "incomplete_background_2.feature");
        } catch (IOException e) {
            e.printStackTrace();
        ...
        assertEquals("Incomplete backgrounds, Part 2", feature.getName());
